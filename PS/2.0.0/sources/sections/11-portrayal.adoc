...
{{PROD.id}} portrayal is intended to provide a way to visualize the contents
of {{PROD.id}} information either in isolation or in combination with an
S-101 ENC.

{{PROD.id}} portrayal is covered by the portrayal model as defined in S-100.
...
{{PROD.id}} uses the portrayal process defined in S-100 Part 9.
...
[[table_11-1]]
.{{PROD.id}} Portrayal Catalogue
[cols="4"]
|===
h| No. h| ISO class or attribute h| Type h| Value

| --    | CI_Citation           | Class                          | --
| 1     | title                 | CharacterString                | {{PROD.id}} Portrayal Catalogue
| 2     | date                  | CI_Date (class)                | --
| 2.1   | date                  | DateTime                       | 2025-12-31 (or later - see note)
| 2.2   | dateType              | CI_DateTypeCode (ISO codelist) | publication
| 3     | edition               | CharacterString                | 2.0.0
| 4     | editionDate           | DateTime                       | 2025-12-31 (or later - see note)
...
| 7.2   | name                  | CharacterString                | {{PROD.id}} Portrayal Catalogue
| 7.3 | description | CharacterString
| XML Portrayal Catalogue accompanied by related files for symbols, colour profiles, rules, etc
...
human-readable versions of the codelists file for S-100 Edition 5.2.0
are located at
...
guidance for online display of the {{PROD.id}} equivalents, since mariners
...
Since S-100 Edition 5.2.0 portrayal does not provide for specifying
...
this edition since S-100 portrayal in Edition 5.2.0 does not provide
